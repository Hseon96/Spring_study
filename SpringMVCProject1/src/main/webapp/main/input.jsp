<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
	JSP는 변경사항이 없다  ---- ajax대신 vue.js를 쓴다 
	EL / JSTL 
	
	데이터를 넘길때는 input type으로!!
	request getParameter가 받는 값은 name값이다!! ****
 --%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="container">
	  <div class="row">
	    ...
	    <form action="output2.do" method="post">
	    <table class="table">
	     <tr>
	     ...
	     <tr>
	       <td colspan="2" class="text-center">
	       	  <input type="submit" value="전송" class="btn btn-sm btn-danger"> <!-- submit이 있으면 form태그는 무조건 있어야한다 -->
	       </td>
	     </tr>
	    </table>
	    </form>
